        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {awards.map((award, index) => (
            <MotionWrapper key={award.name + award.date} delay={index * 0.1}>
              <GlassCard className="p-4 dark:border-teal-500/10 hover:border-teal-500/30 transition-all duration-300 flex flex-col h-full">
                ...
                <div className="flex flex-col space-y-2 mt-auto">
                  <div className="flex justify-between items-center">
                    ...
                    <motion.span
                      className="text-xs px-2 py-1 bg-teal-500/10 rounded-full"
